            ...
            <Box sx={{ flexGrow: 0 }}>
              ...
              >
                {settings.map((setting) => (
                  <MenuItem sx={{color:"red"}} key={setting} onClick={handleLogout}>
      ...
      >
        <List sx={{backgroundColor:"red"}}>
          {pages.map((page, index) => (
            <div key={page.title}>
              <ListItem sx={{color:"white"}} button onClick={() => handleToggleDropdown(index)}>
                <MailIcon sx={{ mr: 2, color: 'white' }} />
                ...
                <List component="div" disablePadding>
                  {page.subItems.map((subItem) => (
                    <ListItem button key={subItem} sx={{ pl: 4 }} component={Link} to={`/${subItem.replace(/\s+/g, '')}`}>
                      <ListItemText primary={subItem} sx={{ color: 'white' }} />
                    </ListItem>
                  ))}
                </List>
              </Collapse>
